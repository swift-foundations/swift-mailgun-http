...
extension Mailgun.Client {
    ...
    ) throws -> Mailgun_Shared_Live.Authenticated<Mailgun.API, Mailgun.API.Router, Mailgun.Client> {
...
extension Mailgun {
    public typealias Authenticated = Mailgun_Shared_Live.Authenticated<Mailgun.API, Mailgun.API.Router, Mailgun.Client>
}
